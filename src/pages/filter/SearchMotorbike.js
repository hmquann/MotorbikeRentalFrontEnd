      ...
      <div className="p-4">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <div name="province"
            ...
            <select className="mt-1 block text-gray-700 w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 sm:text-sm ">
