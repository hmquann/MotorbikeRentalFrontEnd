...
const Regulations = () => {
  return (
    <div className="p-6 bg-white dark:bg-zinc-800">
      <h1 className="text-center text-6xl font-bold mb-4">Nguyên tắc chung</h1>
      <div className="text-zinc-700 dark:text-zinc-300">
        {/* Nội dung Nguyên tắc chung */}
        <>
          <h2>
            <strong>
          ...
          <p>
            ...
            Motorbike Rental Service hướng đến việc xây dựng một cộng đồng thuê xe máy với mong
              ...
              cố nào đối với xe trên chuyến đi của bạn, hãy mạnh dạn giải quyết
              với chủ xe một cách TRUNG THỰC và CÓ TRÁCH NHIỆM.
            </span>
          </p>
          <h2>
            <strong>
              <span style={{ fontSize: "17pt" }}>2. Tạo sự tin tưởng</span>
            </strong>
          </h2>
          <p>
            <span style={{ fontSize: "11pt" }}>
              ...
              khách thuê TIN TƯỞNG và tỉ lệ thuê xe của bạn sẽ cao hơn. Bạn có
              thể kiểm tra trực tuyến hồ sơ của khách hàng trước khi quyết định
              cho thuê, điều này sẽ giúp bạn an tâm hơn trước khi giao chìa khóa
              xe cho những vị khách của mình.
            </span>
          </p>
          <h2>
            <strong>
              <span style={{ fontSize: "17pt" }}>3. Hãy giữ xe sạch sẽ</span>
            </strong>
          </h2>
          <p>
            <span style={{ fontSize: "11pt" }}>
          ...
          <h2>
            <strong>
              <span style={{ fontSize: "17pt" }}>5. Tuân thủ pháp luật</span>
            </strong>
          </h2>
          <p>
            <span style={{ fontSize: "11pt" }}>
              Các chủ xe có trách nhiệm đảm bảo xe của bạn có đầy đủ giấy tờ
              pháp lý và trong tình trạng AN TOÀN trước khi giao xe cho khách.
              Khách thuê xe có trách nhiệm CHẤP HÀNH nghiêm chỉnh luật lệ giao
              thông và tuân thủ tất cả các điều luật hiện hành có liên quan
              trong thời gian thuê xe.
            </span>
          </p>
          <h2>
            <strong>
              <span style={{ fontSize: "17pt" }}>Cuối cùng</span>
            </strong>
          </h2>
          <p>
            <span style={{ fontSize: "11pt" }}>
