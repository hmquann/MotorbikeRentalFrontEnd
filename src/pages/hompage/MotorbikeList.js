            ...
            <div className="p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {motorbikeList.map((motorbike) => (
                        <div key={motorbike.id} className={cardClasses} onClick={() => handleViewDetail(motorbike.id)}>
                            <div className="relative">
                                <img className="w-full h-64 object-cover" src="https://minhlongmoto.com/wp-content/uploads/2023/04/gia-air-blade-125-doi-moi.jpg" alt="Motorbike Image" />
